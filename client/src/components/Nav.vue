    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="/" class="-m-1.5 p-1.5">
          <span class="sr-only">Adeel Raza Azeemi</span>
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <RouterLink to="/projects" class="text-sm/6 font-semibold text-gray-900">
          Projects
        </RouterLink>
        <Popover class="relative">
          ...
          <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
            ...
            leave-from-class="translate-y-0" leave-to-class="opacity-0 translate-y-1">
            <PopoverPanel
              ...
              <div class="p-4">
                <div v-for="item in technicalArticles" :key="item.name"
