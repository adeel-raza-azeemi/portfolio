  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">Importing SQL Server to MySQL</h2>
...
const posts = [
  {
    id: 1,
    title: 'Importing data from SQL Server to MySQL: A step-by-step guide',
    href: '#',
    description:
